...
public:
	...
	bool read(LPCSTR);
	bool read(I23D::ISTREAM*);
	bool write(LPCSTR, int, LPCSTR*, int, size_t = 0);
	bool write(I23D::OSTREAM*, int, LPCSTR*, int, size_t = 0);
	void flush();
	void release();
...
protected:
	...
	void write_scalar_type(I23D::OSTREAM*, int);

	/* read a line from a file and break it up into separate words */
	typedef I23D::TokenInputStream<false> STRISTREAM;
	...
	void get_binary_item(I23D::ISTREAM*, int, ValueType&);
...
public:
	...
	I23D::MemFile* mfp;         /* mem file pointer */
	I23D::IOSTREAM* fp;         /* file pointer */
	I23D::OSTREAM* f;           /* output file pointer */
