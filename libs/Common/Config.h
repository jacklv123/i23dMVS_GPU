...
#ifndef __I23D_CONFIG_H__
#define __I23D_CONFIG_H__
...
#define COMPILE_TIME_ASSERT(expression) \
	NOWARNUNUSED typedef char CTA##__LINE__[::I23D_ASSERT::compile_time_assert<(bool)(expression)>::value]

#define ASSERT_ARE_SAME_TYPE(type1, type2) \
	NOWARNUNUSED typedef char AAST##__LINE__[::I23D_ASSERT::assert_are_same_type<type1,type2>::value]

#define ASSERT_ARE_NOT_SAME_TYPE(type1, type2) \
	NOWARNUNUSED typedef char AANST##__LINE__[::I23D_ASSERT::assert_are_not_same_type<type1,type2>::value]
/*----------------------------------------------------------------*/

#endif // __I23D_CONFIG_H__
