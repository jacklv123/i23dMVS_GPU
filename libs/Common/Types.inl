...
template <> struct hash<I23D::ImageRef>
{
	typedef I23D::ImageRef argument_type;
...
FORCEINLINE I23D::TPoint2<TYPE> SQUARE(const I23D::TPoint2<TYPE>& v)
{
	return I23D::TPoint2<TYPE>(SQUARE(v.x), SQUARE(v.y));
}
template <typename TYPE>
FORCEINLINE I23D::TPoint3<TYPE> SQUARE(const I23D::TPoint3<TYPE>& v)
{
	return I23D::TPoint3<TYPE>(SQUARE(v.x), SQUARE(v.y), SQUARE(v.z));
}
template <typename TYPE, int m, int n>
FORCEINLINE I23D::TMatrix<TYPE,m,n> SQUARE(const I23D::TMatrix<TYPE,m,n>& v)
{
	I23D::TMatrix<TYPE,m,n> nv;
	for (int i=0; i<m*n; ++i)
		nv(i) = SQUARE(v.val[i]);
	return nv;
}
template <typename TYPE>
FORCEINLINE I23D::TPoint2<TYPE> SQUARE(const cv::Point_<TYPE>& v)
{
	return I23D::TPoint2<TYPE>(SQUARE(v.x), SQUARE(v.y));
}
template <typename TYPE>
FORCEINLINE I23D::TPoint3<TYPE> SQUARE(const cv::Point3_<TYPE>& v)
{
	return I23D::TPoint3<TYPE>(SQUARE(v.x), SQUARE(v.y), SQUARE(v.z));
}
template <typename TYPE, int m, int n>
FORCEINLINE I23D::TMatrix<TYPE,m,n> SQUARE(const cv::Matx<TYPE,m,n>& v)
{
	I23D::TMatrix<TYPE,m,n> nv;
	for (int i=0; i<m*n; ++i)
		nv(i) = SQUARE(v.val[i]);
...
template <typename TYPE>
FORCEINLINE I23D::TPixel<TYPE> SQUARE(const I23D::TPixel<TYPE>& v)
{
	return I23D::TPixel<TYPE>(SQUARE(v.r), SQUARE(v.g), SQUARE(v.b));
}
template <typename TYPE>
FORCEINLINE I23D::TColor<TYPE> SQUARE(const I23D::TColor<TYPE>& v)
{
	return I23D::TColor<TYPE>(SQUARE(v.r), SQUARE(v.g), SQUARE(v.b), SQUARE(v.a));
}

// sqrt
template <typename TYPE>
FORCEINLINE I23D::TPoint2<TYPE> SQRT(const I23D::TPoint2<TYPE>& v)
{
	return I23D::TPoint2<TYPE>(SQRT(v.x), SQRT(v.y));
}
template <typename TYPE>
FORCEINLINE I23D::TPoint3<TYPE> SQRT(const I23D::TPoint3<TYPE>& v)
{
	return I23D::TPoint3<TYPE>(SQRT(v.x), SQRT(v.y), SQRT(v.z));
}
template <typename TYPE, int m, int n>
FORCEINLINE I23D::TMatrix<TYPE,m,n> SQRT(const I23D::TMatrix<TYPE,m,n>& v)
{
	I23D::TMatrix<TYPE,m,n> nv;
	for (int i=0; i<m*n; ++i)
		nv(i) = SQRT(v.val[i]);
...
template <typename TYPE>
FORCEINLINE I23D::TPoint2<TYPE> SQRT(const cv::Point_<TYPE>& v)
{
	return I23D::TPoint2<TYPE>(SQRT(v.x), SQRT(v.y));
}
template <typename TYPE>
FORCEINLINE I23D::TPoint3<TYPE> SQRT(const cv::Point3_<TYPE>& v)
{
	return I23D::TPoint3<TYPE>(SQRT(v.x), SQRT(v.y), SQRT(v.z));
}
template <typename TYPE, int m, int n>
FORCEINLINE I23D::TMatrix<TYPE,m,n> SQRT(const cv::Matx<TYPE,m,n>& v)
{
	I23D::TMatrix<TYPE,m,n> nv;
	for (int i=0; i<m*n; ++i)
		nv(i) = SQRT(v.val[i]);
...
template <typename TYPE>
FORCEINLINE I23D::TPixel<TYPE> SQRT(const I23D::TPixel<TYPE>& v)
{
	return I23D::TPixel<TYPE>(SQRT(v.r), SQRT(v.g), SQRT(v.b));
}
template <typename TYPE>
FORCEINLINE I23D::TColor<TYPE> SQRT(const I23D::TColor<TYPE>& v)
{
	return I23D::TColor<TYPE>(SQRT(v.r), SQRT(v.g), SQRT(v.b), SQRT(v.a));
}

// exp
template <typename TYPE>
FORCEINLINE I23D::TPoint2<TYPE> EXP(const I23D::TPoint2<TYPE>& v)
{
	return I23D::TPoint2<TYPE>(EXP(v.x), EXP(v.y));
}
template <typename TYPE>
FORCEINLINE I23D::TPoint3<TYPE> EXP(const I23D::TPoint3<TYPE>& v)
{
	return I23D::TPoint3<TYPE>(EXP(v.x), EXP(v.y), EXP(v.z));
}
template <typename TYPE, int m, int n>
FORCEINLINE I23D::TMatrix<TYPE,m,n> EXP(const I23D::TMatrix<TYPE,m,n>& v)
{
	I23D::TMatrix<TYPE,m,n> nv;
	for (int i=0; i<m*n; ++i)
		nv(i) = EXP(v.val[i]);
...
template <typename TYPE>
FORCEINLINE I23D::TPoint2<TYPE> EXP(const cv::Point_<TYPE>& v)
{
	return I23D::TPoint2<TYPE>(EXP(v.x), EXP(v.y));
}
template <typename TYPE>
FORCEINLINE I23D::TPoint3<TYPE> EXP(const cv::Point3_<TYPE>& v)
{
	return I23D::TPoint3<TYPE>(EXP(v.x), EXP(v.y), EXP(v.z));
}
template <typename TYPE, int m, int n>
FORCEINLINE I23D::TMatrix<TYPE,m,n> EXP(const cv::Matx<TYPE,m,n>& v)
{
	I23D::TMatrix<TYPE,m,n> nv;
	for (int i=0; i<m*n; ++i)
		nv(i) = EXP(v.val[i]);
...
template <typename TYPE>
FORCEINLINE I23D::TPixel<TYPE> EXP(const I23D::TPixel<TYPE>& v)
{
	return I23D::TPixel<TYPE>(EXP(v.r), EXP(v.g), EXP(v.b));
}
template <typename TYPE>
FORCEINLINE I23D::TColor<TYPE> EXP(const I23D::TColor<TYPE>& v)
{
	return I23D::TColor<TYPE>(EXP(v.r), EXP(v.g), EXP(v.b), EXP(v.a));
}

// loge
template <typename TYPE>
FORCEINLINE I23D::TPoint2<TYPE> LOGN(const I23D::TPoint2<TYPE>& v)
{
	return I23D::TPoint2<TYPE>(LOGN(v.x), LOGN(v.y));
}
template <typename TYPE>
FORCEINLINE I23D::TPoint3<TYPE> LOGN(const I23D::TPoint3<TYPE>& v)
{
	return I23D::TPoint3<TYPE>(LOGN(v.x), LOGN(v.y), LOGN(v.z));
}
template <typename TYPE, int m, int n>
FORCEINLINE I23D::TMatrix<TYPE,m,n> LOGN(const I23D::TMatrix<TYPE,m,n>& v)
{
	I23D::TMatrix<TYPE,m,n> nv;
	for (int i=0; i<m*n; ++i)
		nv(i) = LOGN(v.val[i]);
...
template <typename TYPE>
FORCEINLINE I23D::TPoint2<TYPE> LOGN(const cv::Point_<TYPE>& v)
{
	return I23D::TPoint2<TYPE>(LOGN(v.x), LOGN(v.y));
}
template <typename TYPE>
FORCEINLINE I23D::TPoint3<TYPE> LOGN(const cv::Point3_<TYPE>& v)
{
	return I23D::TPoint3<TYPE>(LOGN(v.x), LOGN(v.y), LOGN(v.z));
}
template <typename TYPE, int m, int n>
FORCEINLINE I23D::TMatrix<TYPE,m,n> LOGN(const cv::Matx<TYPE,m,n>& v)
{
	I23D::TMatrix<TYPE,m,n> nv;
	for (int i=0; i<m*n; ++i)
		nv(i) = LOGN(v.val[i]);
...
template <typename TYPE>
FORCEINLINE I23D::TPixel<TYPE> LOGN(const I23D::TPixel<TYPE>& v)
{
	return I23D::TPixel<TYPE>(LOGN(v.r), LOGN(v.g), LOGN(v.b));
}
template <typename TYPE>
FORCEINLINE I23D::TColor<TYPE> LOGN(const I23D::TColor<TYPE>& v)
{
	return I23D::TColor<TYPE>(LOGN(v.r), LOGN(v.g), LOGN(v.b), LOGN(v.a));
}

// abs
template <typename TYPE>
FORCEINLINE I23D::TPoint2<TYPE> ABS(const I23D::TPoint2<TYPE>& v)
{
	return I23D::TPoint2<TYPE>(ABS(v.x), ABS(v.y));
}
template <typename TYPE>
FORCEINLINE I23D::TPoint3<TYPE> ABS(const I23D::TPoint3<TYPE>& v)
{
	return I23D::TPoint3<TYPE>(ABS(v.x), ABS(v.y), ABS(v.z));
}
template <typename TYPE, int m, int n>
FORCEINLINE I23D::TMatrix<TYPE,m,n> ABS(const I23D::TMatrix<TYPE,m,n>& v)
{
	I23D::TMatrix<TYPE,m,n> nv;
	for (int i=0; i<m*n; ++i)
		nv(i) = ABS(v.val[i]);
...
template <typename TYPE>
FORCEINLINE I23D::TPoint2<TYPE> ABS(const cv::Point_<TYPE>& v)
{
	return I23D::TPoint2<TYPE>(ABS(v.x), ABS(v.y));
}
template <typename TYPE>
FORCEINLINE I23D::TPoint3<TYPE> ABS(const cv::Point3_<TYPE>& v)
{
	return I23D::TPoint3<TYPE>(ABS(v.x), ABS(v.y), ABS(v.z));
}
template <typename TYPE, int m, int n>
FORCEINLINE I23D::TMatrix<TYPE,m,n> ABS(const cv::Matx<TYPE,m,n>& v)
{
	I23D::TMatrix<TYPE,m,n> nv;
	for (int i=0; i<m*n; ++i)
		nv(i) = ABS(v.val[i]);
...
// round
template <typename TYPE>
FORCEINLINE I23D::TPoint2<int32_t> Floor2Int(const cv::Point_<TYPE>& v)
{
	return I23D::TPoint2<int32_t>(FLOOR2INT(v.x), FLOOR2INT(v.y));
}
template <typename TYPE>
FORCEINLINE I23D::TPoint2<int32_t> Ceil2Int(const cv::Point_<TYPE>& v)
{
	return I23D::TPoint2<int32_t>(CEIL2INT(v.x), CEIL2INT(v.y));
}
template <typename TYPE>
FORCEINLINE I23D::TPoint2<int32_t> Round2Int(const cv::Point_<TYPE>& v)
{
	return I23D::TPoint2<int32_t>(ROUND2INT(v.x), ROUND2INT(v.y));
}

template <typename TYPE>
FORCEINLINE I23D::TPoint3<int32_t> Floor2Int(const cv::Point3_<TYPE>& v)
{
	return I23D::TPoint3<int32_t>(FLOOR2INT(v.x), FLOOR2INT(v.y), FLOOR2INT(v.z));
}
template <typename TYPE>
FORCEINLINE I23D::TPoint3<int32_t> Ceil2Int(const cv::Point3_<TYPE>& v)
{
	return I23D::TPoint3<int32_t>(CEIL2INT(v.x), CEIL2INT(v.y), CEIL2INT(v.z));
}
template <typename TYPE>
FORCEINLINE I23D::TPoint3<int32_t> Round2Int(const cv::Point3_<TYPE>& v)
{
	return I23D::TPoint3<int32_t>(ROUND2INT(v.x), ROUND2INT(v.y), ROUND2INT(v.z));
}

template <typename TYPE, int m, int n>
FORCEINLINE I23D::TMatrix<TYPE,m,n> Floor2Int(const cv::Matx<TYPE,m,n>& v)
{
	I23D::TMatrix<TYPE,m,n> nv;
	for (int i=0; i<m*n; ++i)
...
template <typename TYPE, int m, int n>
FORCEINLINE I23D::TMatrix<TYPE,m,n> Ceil2Int(const cv::Matx<TYPE,m,n>& v)
{
	I23D::TMatrix<TYPE,m,n> nv;
	for (int i=0; i<m*n; ++i)
...
template <typename TYPE, int m, int n>
FORCEINLINE I23D::TMatrix<TYPE,m,n> Round2Int(const cv::Matx<TYPE,m,n>& v)
{
	I23D::TMatrix<TYPE,m,n> nv;
	for (int i=0; i<m*n; ++i)
...
// ISFINITE
template <typename TYPE>
FORCEINLINE bool ISFINITE(const I23D::TPoint2<TYPE>& v)
{
	return (ISFINITE(v.x) && ISFINITE(v.y));
}
template <typename TYPE>
FORCEINLINE bool ISFINITE(const I23D::TPoint3<TYPE>& v)
{
	return (ISFINITE(v.x) && ISFINITE(v.y) && ISFINITE(v.z));
}
template <typename TYPE>
FORCEINLINE bool ISFINITE(const I23D::TDMatrix<TYPE>& v)
{
...
// operator /
template <typename TYPE, typename TYPEM>
FORCEINLINE I23D::TPoint2<TYPE> operator/(TYPEM n, const cv::Point_<TYPE>& d) {
	return I23D::TPoint2<TYPE>(n/d.x, n/d.y);
}
template <typename TYPE, typename TYPEM>
FORCEINLINE I23D::TPoint3<TYPE> operator/(TYPEM n, const cv::Point3_<TYPE>& d) {
	return I23D::TPoint3<TYPE>(n/d.x, n/d.y, n/d.z);
}
template <typename TYPE, typename TYPEM>
FORCEINLINE I23D::TPixel<TYPE> operator/(TYPEM n, const I23D::TPixel<TYPE>& d) {
	return I23D::TPixel<TYPE>(n/d.r, n/d.g, n/d.b);
}
template <typename TYPE, typename TYPEM>
FORCEINLINE I23D::TColor<TYPE> operator/(TYPEM n, const I23D::TColor<TYPE>& d) {
	return I23D::TColor<TYPE>(n/d.r, n/d.g, n/d.b, n/d.a);
}
/*----------------------------------------------------------------*/
...
DEFINE_CVDATADEPTH(I23D::hfloat)
DEFINE_CVDATADEPTH(I23D::cuint32_t)

// define specialized cv:DataType<>
DEFINE_CVDATATYPE(I23D::hfloat)
DEFINE_CVDATATYPE(I23D::cuint32_t)
/*----------------------------------------------------------------*/
DEFINE_CVDATATYPE(I23D::Point2i)
DEFINE_CVDATATYPE(I23D::Point2hf)
DEFINE_CVDATATYPE(I23D::Point2f)
DEFINE_CVDATATYPE(I23D::Point2d)
/*----------------------------------------------------------------*/
DEFINE_CVDATATYPE(I23D::Point3i)
DEFINE_CVDATATYPE(I23D::Point3hf)
DEFINE_CVDATATYPE(I23D::Point3f)
DEFINE_CVDATATYPE(I23D::Point3d)
/*----------------------------------------------------------------*/
DEFINE_CVDATATYPE(I23D::Pixel8U)
DEFINE_CVDATATYPE(I23D::Pixel32F)
DEFINE_CVDATATYPE(I23D::Pixel64F)
/*----------------------------------------------------------------*/
DEFINE_CVDATATYPE(I23D::Color8U)
DEFINE_CVDATATYPE(I23D::Color32F)
DEFINE_CVDATATYPE(I23D::Color64F)
/*----------------------------------------------------------------*/
DEFINE_GENERIC_CVDATATYPE(I23D::DMatrix8S, uint8_t)
DEFINE_GENERIC_CVDATATYPE(I23D::DMatrix8U, uint8_t)
DEFINE_GENERIC_CVDATATYPE(I23D::DMatrix32S, uint8_t)
DEFINE_GENERIC_CVDATATYPE(I23D::DMatrix32U, uint8_t)
DEFINE_GENERIC_CVDATATYPE(I23D::DMatrix32F, uint8_t)
DEFINE_GENERIC_CVDATATYPE(I23D::DMatrix64F, uint8_t)
/*----------------------------------------------------------------*/
DEFINE_GENERIC_CVDATATYPE(I23D::DVector8S, uint8_t)
DEFINE_GENERIC_CVDATATYPE(I23D::DVector8U, uint8_t)
DEFINE_GENERIC_CVDATATYPE(I23D::DVector32S, uint8_t)
DEFINE_GENERIC_CVDATATYPE(I23D::DVector32U, uint8_t)
DEFINE_GENERIC_CVDATATYPE(I23D::DVector32F, uint8_t)
DEFINE_GENERIC_CVDATATYPE(I23D::DVector64F, uint8_t)
/*----------------------------------------------------------------*/
DEFINE_GENERIC_CVDATATYPE(I23D::Image8U, uint8_t)
DEFINE_GENERIC_CVDATATYPE(I23D::Image16F, uint8_t)
DEFINE_GENERIC_CVDATATYPE(I23D::Image32F, uint8_t)
DEFINE_GENERIC_CVDATATYPE(I23D::Image64F, uint8_t)
DEFINE_GENERIC_CVDATATYPE(I23D::Image8U3, uint8_t)
DEFINE_GENERIC_CVDATATYPE(I23D::Image8U4, uint8_t)
DEFINE_GENERIC_CVDATATYPE(I23D::Image32F3, uint8_t)
DEFINE_GENERIC_CVDATATYPE(I23D::Image32F4, uint8_t)
/*----------------------------------------------------------------*/
...
template <typename TYPE>
bool SerializeSave(const TYPE& obj, const I23D::String& fileName, ARCHIVE_TYPE type, unsigned flags=0)
{
...
template <typename TYPE>
bool SerializeLoad(TYPE& obj, const I23D::String& fileName, ARCHIVE_TYPE type, unsigned flags=0)
{
...
class MiniDumper {
public:
	static inline void Create(const I23D::String& strAppNameANSI, I23D::String strDumpPathANSI, MINIDUMP_TYPE dumpType=MiniDumpNormal, bool bOutOfProcess=true) {
		static MiniDumper oMiniDumper(strAppNameANSI, strDumpPathANSI, dumpType, bOutOfProcess);
	}
	static inline void Create(const I23D::String& strAppNameANSI, I23D::String strDumpPathANSI, int verbosity, bool bOutOfProcess=true) {
	...
	MiniDumper(const I23D::String& strAppNameANSI, I23D::String strDumpPathANSI, MINIDUMP_TYPE dumpType=MiniDumpNormal, bool bOutOfProcess=true)
		:
		crash_server(NULL),
		handler(NULL)
	{
		if (strDumpPathANSI.IsEmpty())
			strDumpPathANSI = I23D::Util::getCurrentDirectory();
		...
		if (bOutOfProcess) {
			...
			const I23D::String strUUIDANSI(I23D::Util::getUniqueName(0));
