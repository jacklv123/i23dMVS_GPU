...
#ifndef __I23D_TYPES_H__
#define __I23D_TYPES_H__
...
#define TIMER_START()		I23D::Timer::SysType timerStart = I23D::Timer::GetSysTime()
#define TIMER_UPDATE()		timerStart = I23D::Timer::GetSysTime()
#define TIMER_GET()			I23D::Timer::SysTime2TimeMs(I23D::Timer::GetSysTime() - timerStart)
#define TIMER_GET_INT()		((I23D::Timer::SysType)TIMER_GET())
#define TIMER_GET_FORMAT()	I23D::Util::formatTime(TIMER_GET_INT())
...
#define FLOOR			I23D::Floor2Int
#define FLOOR2INT		I23D::Floor2Int
#define CEIL			I23D::Ceil2Int
#define CEIL2INT		I23D::Ceil2Int
#define ROUND			I23D::Round2Int
#define ROUND2INT		I23D::Round2Int
#define SIN				sinf
#define ASIN			asinf
#define COS				cosf
#define ACOS			acosf
...
typedef I23D::cList<DMatrix, const DMatrix&, 2> DMatrixArr;
typedef I23D::cList<cv::Mat, const cv::Mat&, 2> MatArr;
/*----------------------------------------------------------------*/
...
typedef I23D::cList<DVector, const DVector&, 2> DVectorArr;
/*----------------------------------------------------------------*/
...
typedef I23D::cList<IndexScore, const IndexScore&, 0> IndexScoreArr;
/*----------------------------------------------------------------*/
...
/*----------------------------------------------------------------*/
typedef I23D::cList<PairIdx, const PairIdx&, 0> PairIdxArr;
