...
public:
    ...
    typedef cList<IDX, IDX, 0> IndexArr;
    typedef cList<uint32_t> Group;
    ...
    bool InsertPartial(RectArr& rects, RectArr& newRects, IndexArr& indices, Group& newGroup, FreeRectChoiceHeuristic method=RectBestShortSideFit);
